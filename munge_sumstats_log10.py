...
## this part was added by shane 

parser.add_argument('--log10pvals',default=False,action='store_true',help='Whether or not the supplied pvals are in -log10 format')
